...
echo "  promptcode config --set-openai-key YOUR_KEY"
echo "  promptcode config --set-anthropic-key YOUR_KEY"
echo "  promptcode config --set-google-key YOUR_KEY"
echo "  promptcode config --set-xai-key YOUR_KEY"